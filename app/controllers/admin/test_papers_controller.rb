class Admin::TestPapersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @test_paper.save
        format.html { redirect_to admin_test_paper_path(@test_paper), notice: 'Test paper was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @test_paper.update(test_paper_params)
        format.html { redirect_to admin_test_paper_path(@test_paper), notice: 'Test paper was successfully updated.' }
